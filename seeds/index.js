...
const seedDB = async () => {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    const camp = new Campground({
      //YOUR USER ID
      author: "627225e91f5174c7ea3e1926",
      ...
      images: [
        {
          url: "https://res.cloudinary.com/dswkd1tqw/image/upload/v1651470970/YelpCamp/tent_rn1yyv.jpg",
          filename: "YelpCamp/tent_rn1yyv.jpg",
        },
      ],
    });
    await camp.save();
