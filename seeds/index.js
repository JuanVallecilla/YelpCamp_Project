...
const seedDB = async () => {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    const camp = new Campground({
      //YOUR USER ID
      author: "626318eabdaaff83c60ef1cc",
      ...
      images: [
        {
          url: "https://res.cloudinary.com/dswkd1tqw/image/upload/v1650857938/YelpCamp/ys9jmsbmfbwztulthjul.jpg",
          filename: "YelpCamp/ys9jmsbmfbwztulthjul",
        },
      ],
    });
    await camp.save();
